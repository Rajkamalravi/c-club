...
<script src="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/events/js/event.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
    ...
    window._evl_cfg = {
        ...
        dojoEventRules: <?= json_encode(DOJO_EVENT_LIST_MESSAGE); ?>,
        ...
        canonicalUrlEnable: <?= json_encode((bool)TAOH_LINK_CANONICAL_URL_ENABLE); ?>,
        dojoSuggestionEnable: <?= json_encode(defined('TAOH_DOJO_SUGGESTION_ENABLE') && TAOH_DOJO_SUGGESTION_ENABLE); ?>,
        dojoSuggestionTimelimit: <?= json_encode(defined('TAOH_DOJO_SUGGESTION_TIMELIMIT') ? (int)TAOH_DOJO_SUGGESTION_TIMELIMIT : 300000); ?>,
