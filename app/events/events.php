...
if (taoh_user_is_logged_in()) {
    ...
    if (isset($get_liked['output']['conttoken_liked'])) {
        $liked_arr = $get_liked['output']['conttoken_liked'];
    }
        ...
        <div class="row">
            <div class="col-lg-7">
                <div class="hero-content pb-5 pt-3">
                    ...
                    <p class="section-desc pb-4 text-white">Embark on a journey of opportunity with events app—where ambition meets possibility.</p>
                    <div class="dark-btn">
...
<?php } ?>
    ...
    <div class="modal share-v1-modal" id="socialShareModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-md" role="document">
            <div class="modal-content light-dark-card">
                ...
                <div class="modal-body">
                    ...
                    <input type="hidden" id="social_event_token" value="">
                    <input type="hidden" id="social_ptoken" value="">
                    <input type="hidden" id="social_from" value="1">
                    <input type="hidden" id="social_contype" value="events">
...
<script src="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/js/event.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
    <script>
        ...
        $(document).ready(function () {
            ...
            // Restore search state AFTER a short delay to ensure TomSelect is initialized
            setTimeout(function() {
                restoreSearchState();

                // If there was a saved state, trigger the search with the restored values
                if (savedState) {
                    const searchState = JSON.parse(savedState);
                    var queryString = $('#searchFilter').serialize();

                    // Update global variables with restored values
                    ...
                    // Normal initial load without saved state
                    <?php if(TAOH_INTAODB_ENABLE) { ?>
                                ...
                                <div class="px-3 pt-3">
                                    <div class="d-flex justify-content-between mb-3" style="gap: 6px;">
                                        ...
                                        <div class="d-flex align-items-center" style="gap: 3px;">
                                            ...
                                            <button class="btn shadow-none border-0 social-share-btn" data-toggle="modal" data-target="#socialShareModal" data-url="${share_event_url}" data-eventtoken="${v.eventtoken}" data-ptoken="<?= $ptoken; ?>" data-title="${v.title}" data-desc="${short_desc}">
        ...
        function restoreSearchState() {
            ...
            if (searchState.coordinateLocation) {
                ...
                // Restore TomSelect location dropdown
            ...
            if (searchState.postdate) {
                ...
                // Show date range inputs if date_range is selected
