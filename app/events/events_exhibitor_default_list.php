...
<ul class="exh-v2-con lblur">
    ...
    <li class="exh-v2-list p-3 px-lg-5 light-dark-card d-flex align-items-center justify-content-between flex-wrap" style="gap: 12px;">
        <div class="d-flex flex-wrap align-items-center">
            <img class="mr-3 mb-3 mb-md-0 mr-lg-5 exh-profile-v1" src="<?php echo TAOH_SITE_URL_ROOT;?>/assets/images/exh-v2-4.png" alt="">

            <div>
                <h6 class="exh-name">Lectron</h6>
                <p class="exh-link">https://lectron.ai</p>
            </div>
...
<ul class="exh-v2-con lblur">
    ...
    <li class="exh-v2-list p-3 px-lg-5 light-dark-card d-flex align-items-center justify-content-between flex-wrap" style="gap: 12px;">
        <div class="d-flex flex-wrap align-items-center">
            <img class="mr-3 mb-3 mb-md-0 mr-lg-5 exh-profile-v1" src="<?php echo TAOH_SITE_URL_ROOT;?>/assets/images/exh-v2-2.png" alt="">

            <div>
                <p class="exh-info-badge">AI Hall</p>
                <h6 class="exh-name">TamQ</h6>
                <p class="exh-link">https://tamq.ai</p>
            </div>
    ...
    <li class="exh-v2-list p-3 px-lg-5 light-dark-card d-flex align-items-center justify-content-between flex-wrap" style="gap: 12px;">
        <div class="d-flex flex-wrap align-items-center">
            <img class="mr-3 mb-3 mb-md-0 mr-lg-5 exh-profile-v1" src="<?php echo TAOH_SITE_URL_ROOT;?>/assets/images/exh-v2-3.png" alt="">

            <div>
                <p class="exh-info-badge">AI Hall</p>
                <h6 class="exh-name">Nutech Laboratories</h6>
                <p class="exh-link">https://nutech.ai</p>
            </div>
...
<ul class="exh-v2-con lblur">
    ...
    <li class="exh-v2-list p-3 px-lg-5 light-dark-card d-flex align-items-center justify-content-between flex-wrap" style="gap: 12px;">
        <div class="d-flex flex-wrap align-items-center">
            <img class="mr-3 mb-3 mb-md-0 mr-lg-5 exh-profile-v1" src="<?php echo TAOH_SITE_URL_ROOT;?>/assets/images/exh-v2-1.png" alt="">

            <div>
                <p class="exh-info-badge">AI Hall</p>
                <h6 class="exh-name">Vitals Informatics and Data Tech</h6>
                <p class="exh-link">https://vitaldata.ai</p>
            </div>
