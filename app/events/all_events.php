...
<link rel="stylesheet" href="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/events/css/all-events.css?v=<?php echo TAOH_CSS_JS_VERSION; ?>">
...
<script src="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/events/js/all-events.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
