<style>
    ...
    .new-exh-list .n-exh-name {
        font-weight: 500;
        font-size: 22px;
    }
    .discussion-tab-inner {
...
<script>
    ...
    //var table_url = "<?php //echo TAO_TABLES_URL; ?>";
    var table_url_index = "<?php echo TAOH_SITE_URL_ROOT.'/events/d/event-'.$eventtoken.'/';?>";
    var cdn_prefix = "<?php echo TAOH_CDN_PREFIX; ?>";
    var current_app_page = "<?php echo TAO_CURRENT_APP_INNER_PAGE; ?>";
    var banner_table =`<div class="v2-banner flex-column flex-md-row p-3 px-lg-5">
                        <div class="v2-svg-con" style="background-color:transparent;">
                           <img src="<?php echo TAO_TABLES_URL.'/images/tables_im_sq.svg';?>" width="50" alt="Tables™ Logo">
                        </div>
                        <div>
        ...
        var no_banner_table =`<div class="v2-banner flex-column flex-md-row p-3 px-lg-5">
                        ...
                        <div>
                            ...
                            <p class="mb-2"> Spark the community with your thoughts.</p>
                            <div class="d-flex align-items-center flex-wrap" style="gap: 6px;">
                                <?php if(TAO_CURRENT_APP_INNER_PAGE == 'events_lobby'){  ?>
                                    <a target="_blank" class="btn banner-v2-btn mt-0 mr-1" id='' href="<?php echo TAOH_SITE_URL_ROOT.'/events/d/event-'.$eventtoken.'/tables/create';?>">Create table</a>
                                    <a target="_blank" class="btn banner-v2-btn mt-0 mr-1" id='' href="<?php echo TAOH_SITE_URL_ROOT.'/events/d/event-'.$eventtoken.'/tables';?>">More Info</a>
                                <?php }  else{ ?>
                                    <span class="info" style="color:#007bff;">Register to create table</span>
