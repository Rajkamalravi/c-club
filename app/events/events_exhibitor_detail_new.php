...
?>
    ...
    <link rel="stylesheet" href="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/css/events-exhibitor-detail.css?v=<?php echo TAOH_CSS_JS_VERSION; ?>">
<div class="detail-hall aw aw-logo aw-loader">
    ...
    <script src="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/js/events-exhibitor-detail.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
