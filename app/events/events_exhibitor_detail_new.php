...
?>
    ...
    <link rel="stylesheet" href="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/events/css/events-exhibitor-detail.css?v=<?php echo TAOH_CSS_JS_VERSION; ?>">
<div class="detail-hall aw aw-logo aw-loader">
    ...
    <script>
        window._exd_cfg = {
            ...
            exhibitorId: <?= json_encode($exhibitor_id ?? 0); ?>,
            ...
            clickView: <?= json_encode($click_view ?? 'view'); ?>,
            userTimezone: <?= json_encode($taoh_user_is_logged_in ? taoh_user_timezone() : ''); ?>,
            currAppSlug: <?= json_encode(TAOH_CURR_APP_SLUG); ?>,
            opsAvatarPrefix: <?= json_encode(TAOH_OPS_PREFIX . '/avatar/PNG/128/'); ?>
                };
    </script>
    <script src="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/events/js/events-exhibitor-detail.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
