...
$current_app = TAOH_SITE_CURRENT_APP_SLUG;
  ...
  //echo TAOH_CDN_PREFIX."/app/$current_app/faq.php";
...
<section class="benefits-area pb-90px bg-light">
    <div class="container">
        <div class="text-center">
            ...
            <p class="section-desc w-75 mx-auto">Jobs will help you get to your next job faster.</p>
        </div>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Connect with Opportunities</h5>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Be Informed Applicant</h5>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Get Community Support</h5>
            ...
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Access Job Tips</h5>
                        <p class="card-text">Get all of your jobs related questions answered through the professional network.</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Learn Job Hacks</h5>
                        <p class="card-text">Stay on top of job hacks and life tips with curated reads.</p>
                    </div><!-- end card-body -->
                </div><!-- end card -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="card card-item hover-y">
                    <div class="card-body">
                        ...
                        <h5 class="card-title pt-4 pb-2">Get Hired Faster</h5>
        ...
        <div class="row">
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box px-3">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Search For Jobs</h3>
                        <p>Search to find open roles that match your expertise and interests.</p>
                    </div>
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box px-3">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Chat with Recruiters</h3>
                        <p>Engage and connect with recruiters to learn more about jobs.</p>
                    </div>
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
            <div class="col-lg-4 responsive-column-half">
                <div class="info-box px-3">
                    ...
                    <div class="info-body">
                        <h3 class="fs-18 pb-3 fw-bold">Apply for Jobs</h3>
                        <p>Apply for jobs that are best suited and improve your success rate.</p>
                    </div>
                </div><!-- end info-box -->
            </div><!-- end col-lg-4 -->
        </div><!-- end row -->
