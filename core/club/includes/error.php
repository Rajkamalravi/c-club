...
<div class="custom-error-page error-overlay">
    <div class="error-container">
        ...
        if ($error_from === 'networking' && in_array($error_code, [1002, 1003, 1004, 1005, 1006, 1007, 1008, 1009, 1010])) {
            ...
            echo '<p>Unable to complete the operation due to a system timeout.</p>';
