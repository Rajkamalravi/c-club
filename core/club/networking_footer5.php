...
<script src="<?php echo TAOH_CHAT_PREFIX; ?>/js/chat4/chat-profile.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
<script src="<?php echo TAOH_CHAT_PREFIX; ?>/js/chat4/chat-footer.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
