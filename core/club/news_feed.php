    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-lg-3">
            ...
            <div class="modal-body">
                <form id="newsfeed_form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-9">
                        <label class="custom-file-upload mr-3">
                            ...
                            <svg width="30" height="26" viewBox="0 0 30 26" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M0.00488281 3.71429C0.00488281 1.66562 1.68652 0 3.75488 0H26.2549C28.3232 0 30.0049 1.66562 30.0049 3.71429V22.2857C30.0049 24.3344 28.3232 26 26.2549 26H3.75488C1.68652 26 0.00488281 24.3344 0.00488281 22.2857V3.71429ZM18.9775 9.89509C18.7139 9.51205 18.2803 9.28571 17.8174 9.28571C17.3545 9.28571 16.915 9.51205 16.6572 9.89509L11.5596 17.3004L10.0068 15.3795C9.7373 15.0487 9.33301 14.8571 8.91113 14.8571C8.48926 14.8571 8.0791 15.0487 7.81543 15.3795L4.06543 20.0223C3.72559 20.4402 3.66113 21.0147 3.89551 21.4964C4.12988 21.9781 4.62207 22.2857 5.16113 22.2857H10.7861H12.6611H24.8486C25.3701 22.2857 25.8506 22.0013 26.0908 21.5429C26.3311 21.0844 26.3018 20.533 26.0088 20.1094L18.9775 9.89509ZM6.56738 9.28571C7.3133 9.28571 8.02868 8.99222 8.55612 8.4698C9.08357 7.94737 9.37988 7.23882 9.37988 6.5C9.37988 5.76118 9.08357 5.05263 8.55612 4.5302C8.02868 4.00778 7.3133 3.71429 6.56738 3.71429C5.82146 3.71429 5.10609 4.00778 4.57865 4.5302C4.0512 5.05263 3.75488 5.76118 3.75488 6.5C3.75488 7.23882 4.0512 7.94737 4.57865 8.4698C5.10609 8.99222 5.82146 9.28571 6.56738 9.28571Z" fill="#555555"/>
                            </svg>
                        ...
                        <label class="custom-file-upload mr-3">
                            ...
                            <path d="M22.5049 4.64531C20.9799 3.12031 18.5049 3.12031 16.9799 4.64531L5.47988 16.1453C2.84863 18.7766 2.84863 23.0391 5.47988 25.6703C8.11113 28.3016 12.3736 28.3016 15.0049 25.6703L24.5049 16.1703C25.1861 15.4891 26.2986 15.4891 26.9799 16.1703C27.6611 16.8516 27.6611 17.9641 26.9799 18.6453L17.4799 28.1453C13.4799 32.1453 7.00488 32.1453 3.00488 28.1453C-0.995117 24.1453 -0.995117 17.6703 3.00488 13.6703L14.5049 2.17031C17.3986 -0.723438 22.0861 -0.723438 24.9799 2.17031C27.8736 5.06406 27.8736 9.75156 24.9799 12.6453L13.9799 23.6453C12.1924 25.4328 9.29238 25.4328 7.50488 23.6453C5.71738 21.8578 5.71738 18.9578 7.50488 17.1703L16.5049 8.17031C17.1861 7.48906 18.2986 7.48906 18.9799 8.17031C19.6611 8.85156 19.6611 9.96406 18.9799 10.6453L9.97988 19.6453C9.56113 20.0641 9.56113 20.7516 9.97988 21.1703C10.3986 21.5891 11.0861 21.5891 11.5049 21.1703L22.5049 10.1703C24.0299 8.64531 24.0299 6.17031 22.5049 4.64531Z" fill="#555555"/>
                            </svg>
                    ...
                    <div class="modal-footer border-0 background-transparent">
                        <button type="submit" class="btn px-4 submit" style="background: #2557A7; color: #fff; border-radius: 20px;">+ &nbsp;<span class="edit_btm">Create</span> Post</button>
                    </div>
                </form>
            </div>
        </div>
...
<div class="modal fade" id="sliderModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content p-lg-3">
            <div class="modal-header px-3" style="background: #fff; border-bottom: 1px solid #D3D3D3 !important;">
                <h5 class="modal-title" id="exampleModalLabel">All Images and Files</h5>
                <button type="button" class="btn d-flex align-items-center" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true" style="color: #D3D3D3; font-size: 19px;">X</span>
                </button>
            </div>
...
<script>
    ...
    $('#postModal').on('hidden.bs.modal', function () {
        $('#newsfeed_form')[0].reset();  // Reset the form
        $('#previewContainer').empty();
        existingFiles = [];
        $('.summernote').summernote('code', '<p></p>');
        $('.edit_btm').html('Create');
    });
		...
		if(data.output === false || data.success  === false) {
            ...
            var no_result = `
             <div class="text-center mb-5">
                <img class="no-feed-img" src="<?php echo TAOH_SITE_URL_ROOT.'/assets/images/announce.png'; ?>" alt="">
                <h4 class="no-feed-title mt-2">It looks like you are Just starting out !</h4>
                <p class="no-feed-desc pt-4 pb-5">
                We are so excited to have you here!
                Stay tuned for some exciting feeds.</p>
                 <?php if($taoh_user_is_logged_in && $is_admin){ ?>
        ...
        $.each(data.output, function(i, v){
            ...
            if(Array.isArray(v.meta.files)){
                ...
                $.each(v.meta.files, function(indexs, values) {
                    ...
                    show_files += `<div class="px-3 py-2">
                                            <a href="${urld}" data-fancybox="gallery">
                                                <img src="${get_src}" />
                                                </a>
                                        </div>`;
                });
            ...
            slot.append(`<div class="${(i == 0)?'':'mt-5'}">
                            <div class="px-3 pb-3" style="border: 1px solid #D3D3D3; border-radius: 3px;">
                            ${edit_btn}
                                ...
                                <div class="py-3 px-3" style="font-size: 16px; line-height: 32px; font-weight: 400; color: #555555; text-align: justify;">
