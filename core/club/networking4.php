...
?>
    ...
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/node-waves/waves.min.css">
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/swiper/swiper-bundle.min.css">
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/glightbox/css/glightbox.min.css">
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/tributejs/tribute.css">
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/css/chat4/icons.min.css">
    <link rel="stylesheet" href="<?php echo TAOH_CHAT_PREFIX; ?>/css/chat4/chat.css?v=<?php echo TAOH_CSS_JS_VERSION;?>">
            ...
            <div class="flex-lg-column my-2 sidemenu-navigation">
                <ul class="nav nav-pills side-menu-nav" role="tablist">
                    ...
                    <li class="nav-item">
                        ...
                        <span class="d-none d-lg-block text-center fs-11">My Channels</span>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link mb-1" data-bs-toggle="pill" href="#" role="tab">
                ...
                <div class="tab-pane" id="pills-user" role="tabpanel" aria-labelledby="pills-user-tab">
                    ...
                    <div>
                        <div class="user-profile-img">
                            <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/profile_cover.jpg" class="profile-img" style="height: 160px;" alt="">
                        ...
                        <div class="text-center border-bottom border-bottom-dashed pt-2 pb-4 mt-n5 position-relative">
                            <div class="mb-lg-3 mb-2">
                                <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/users/avatar-maxresdefault.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="">
                            </div>
                            ...
                            <div class="border-bottom border-bottom-dashed mb-4 pb-4">
                                ...
                                <div class="profile-media-img">
                                    <div class="media-img-list">
                                        <a href="#">
                                            <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/small/img-maxresdefault.jpg" alt="media img" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="media-img-list">
                                        <a href="#">
                                            <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/small/img-2.jpg" alt="media img" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="media-img-list">
                                        <a href="#">
                                            <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/small/img-4.jpg" alt="media img" class="img-fluid">
                            ...
                            <div>
                                ...
                                <div>
                                    <div class="card p-2 border border-dashed mb-2">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 ms-1 me-3">
                                                <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/pdf-file.png" alt="" class="avatar-xs">
                                            </div>
                                    ...
                                    <div class="card p-2 border border-dashed mb-2">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 ms-1 me-3">
                                                <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/image-file.png" alt="" class="avatar-xs">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                                    ...
                                    <div class="card p-2 border border-dashed mb-0">
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 ms-1 me-3">
                                                <img src="<?php echo TAOH_CHAT_PREFIX; ?>/images/chat4/zip-file.png" alt="" class="avatar-xs">
                                            </div>
                                            <div class="flex-grow-1 overflow-hidden">
                ...
                <div class="tab-pane show active" id="pills-chat" role="tabpanel" aria-labelledby="pills-chat-tab">
                    ...
                    <div>
                        <div class="chat-room-list" data-simplebar>
                            ...
                            <div class="my_channel_div d-none1">
                                <div class="w-hide">
                                    <div class="left-section  d-flex align-items-center px-4 mt-4 mb-2">
                                        <div class="flex-grow-1">
                            ...
                            <div data-intro="Find all the participants here" data-step="1" class="w-hide">
                                <div class="left-section d-flex align-items-center px-4 mt-4 mb-2">
                                    <div class="flex-grow-1 mt-2 mb-2 participants_refresh" >
                                        <h4 class="mb-0 fs-11 text-muted text-uppercase cursor-pointer">Participants</h4>
                                    </div>
                                    <div class="flex-shrink-0">
                                ...
                                <div class="left-section chat-message-list mb-3">
                                    ...
                                    <div class="collapse show" id="channelCollapse">
                                        ...
                                        <ul class="list-unstyled chat-list chat-user-list">
                                            <li id="browseMoreChannels">
                                                <a class="align-items-center justify-content-between w-hide" href="javascript: void(0);">
                                                    <div class="channel_btn flex-grow-1 d-flex align-items-center overflow-hidden py-3">
                            ...
                            <?php if(ORGANIZER_CHANNEL_ENABLE && !empty($event_owner_ptoken)) { ?>
                                ...
                                <div class="chat-message-list">
                                    <ul class="organizerChannelList list-unstyled chat-list chat-user-list" id="organizerChannelList" style="display: none;">
                    ...
                    <div id="browse_channels_wrapper" class="position-relative" style="display: none; max-width: 1200px;">
                        <div class="px-4 py-3 pb-xl-0">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-2">
                                ...
                                <h4 id="browse_channel_heading" class="ch-main-title d-none">All Exhibitors</h4>
...
<!--                                    <a class="btn"><i class="fa-solid fa-angles-left"></i> Back</a>-->
                            ...
                            <div>
                                <form id="browseChannelFilterForm" class="search-form p-0 rounded-0 bg-transparent shadow-none position-relative z-index-1 mb-2">
                                    <div class="d-flex flex-wrap align-items-center">
                                        <div class="d-flex flex-wrap align-items-center flex-grow-1">
                                ...
                                <ul class="nav nav-tabs flex-wrap align-items-center mb-2 border-0" style="gap: 10px;" id="browseChannelTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link btn bor-btn py-2 active" id="all-tab" data-toggle="tab" href="#all-ch" role="tab">
                                            All Channels
                                        </a>
                                    </li>
                                    <?php
                                    if ($isEventNetworking) {
                                        ?>
                                        <li class="nav-item">
                                            <a class="nav-link btn bor-btn py-2" id="exhibitors-tab" data-toggle="tab" href="#exhibitors" role="tab">
                                                Exhibitors
                                            </a>
                                        </li>
<!--                                        <li class="nav-item">-->
<!--                                            <a class="nav-link btn bor-btn py-2" id="sponsors-tab" data-toggle="tab" href="#sponsors" role="tab">-->
<!--                                                Sponsors-->
<!--                                            </a>-->
<!--                                        </li>-->
                                        <li class="nav-item">
                                            <a class="nav-link btn bor-btn py-2" id="sessions-tab" data-toggle="tab" href="#sessions" role="tab">
                                                Sessions
                                            </a>
                                        </li>
                                        <?php
                                 ...
                                 <div class="all-channels tab-content pt-3" id="myTabContent">
                                    <div class="tab-pane fade show active" id="all-ch" role="tabpanel">
                                        <div class="channel-lists list-scroll-onmobile aw aw-logo" id="browse_channels">
                                     ...
                                     if ($isEventNetworking) {
                                         ...
                                         <div class="tab-pane fade" id="exhibitors" role="tabpanel">
                                             <div class="exh-lists list-scroll-onmobile aw aw-logo" id="browse_exhibitor_channels">

                                             </div>
                                         </div>
<!--                                         <div class="tab-pane fade" id="sponsors" role="tabpanel">-->
<!--                                             <div class="sponsor-lists list-scroll-onmobile aw aw-logo" id="browse_sponsor_channels">-->
<!---->
<!--                                             </div>-->
<!--                                         </div>-->
                                         <div class="tab-pane fade" id="sessions" role="tabpanel">
                                             <div class="session-lists list-scroll-onmobile aw aw-logo" id="browse_session_channels">
                    ...
                    <div id="speed_networking" class="position-relative" style="display: none1; max-width: 1200px;">
                        <div>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h6 class="d-flex align-items-center mb-0 fs-18" style="gap: 6px;">
                                                            ...
                                                            <button type="button" toggle_text="open" class="channel_toggle btn box-shadow-none p-0">
                            ...
                            <div class="speed_networking_div container py-3 px-lg-4 d-none1">
                            ...
                            <div class="successMatchDiv container pt-4 px-lg-4 d-none">
                                <div class="speed-nw-card p-3 p-lg-5 d-flex flex-column align-items-center">
                                    ...
                                    <button type="button" class="btn speed-v1-b-btn openchatacc">Chat now!</button>
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div id="channel-chat-topbar-info" class="flex-grow-1 overflow-hidden">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 overflow-hidden">
                                                        <h6 class="d-flex align-items-center mb-0 fs-18" style="gap: 6px;">
                                                            <span class="text-capitalize cw_channel_title text-reset text-truncate"></span>
                                                            <button type="button" toggle_text="open" class="channel_toggle btn box-shadow-none p-0">
                                                        ...
                                                        <div style="width:200px;" class="dropdown-menu dropdown-menu-end">
                                                            ...
                                                            <button type="button" class="dropdown-item d-flex align-items-center justify-content-between send_transcript_btn" data-channelid="" data-channeltype="" data-channelname="">Send Transcript
                                                                <img data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="top" title="Click this icon to get the chat conversation via mail"
                                                                    src="<?php echo TAOH_SITE_URL_ROOT; ?>/assets/images/email_fwd.png" class="send_transcript" style="width:30px;height:30px;" />
                                                            </button>
                            ...
                            <div class="collapse" id="createChannelMoreOptions">
                                <div>
                                    <div class="mb-4">
                                        ...
                                        <input type="text" name="channelpasscode" class="form-control" id="channelpasscode" autocomplete="off" placeholder="Passcode if needed">
                                    </div>
                    ...
                    <div class="modal-body px-lg-5 pb-4">
                        <div class="tab-content pt-3" id="membersTabContent">
                            ...
                            <div class="tab-pane fade" id="members" role="tabpanel">
                                <div class="d-flex align-items-center mb-4 add_members_wrapper add_channel_members cursor-pointer">
                                    <div class="flex-shrink-0">
                                ...
                                <div class="members-lists" id="membersList">
...
?>
    ...
    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/bootstrap/js/bootstrap.bundle.min.js"></script>
    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/simplebar/simplebar.min.js"></script>
    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/node-waves/waves.min.js"></script>
    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/swiper/swiper-bundle.min.js"></script>

    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/glightbox/js/glightbox.min.js"></script>
    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/libs/chat4/fg-emoji-picker/fgEmojiPicker.js"></script>
    ...
    <script type="text/javascript">
        ...
        let ntw_keyword = '<?php echo !empty($eventtoken) ? $eventtoken : 'club'; ?>';
        ...
        let chatWithChannel = '<?= $chatwithChannel ?>';

        let event_channels = [];
        if (eventToken) {
            try {
                event_channels = JSON.parse(<?= json_encode($event_channels ?: '[]', JSON_UNESCAPED_UNICODE|JSON_HEX_TAG|JSON_HEX_AMP|JSON_HEX_APOS|JSON_HEX_QUOT) ?>);
            } catch (err) {
                console.error('Invalid event_channels JSON:', err);
                event_channels = [];
            }
        }
...
<!--    <script src="--><?php //echo TAOH_CHAT_PREFIX; ?><!--/js/chat4/chat.js?v=--><?php //echo TAOH_CSS_JS_VERSION; ?><!--"></script>-->
<!--    <script src="--><?php //echo TAOH_CHAT_PREFIX; ?><!--/js/chat4/chat-group.js?v=--><?php //echo TAOH_CSS_JS_VERSION; ?><!--"></script>-->
<!--    <script src="--><?php //echo TAOH_CHAT_PREFIX; ?><!--/js/chat4/chat-direct.js?v=--><?php //echo TAOH_CSS_JS_VERSION; ?><!--"></script>-->
    <script src="<?php echo TAOH_CHAT_PREFIX; ?>/js/chat4/chat-common.js?v=<?php echo TAOH_CSS_JS_VERSION; ?>"></script>
<!--    <script src="--><?php //echo TAOH_CHAT_PREFIX; ?><!--/js/chat4/chat-dojo.js?v=--><?php //echo TAOH_CSS_JS_VERSION; ?><!--"></script>-->
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            getNTWUserChannels({
                ...
                if (response && response.length) {
                    renderSpeedChannelList(response);
                }
            });
            ...
            if(chatWithChannel != "") {
                loadChannelInfoPopup(chatWithChannel);
            }

            // Create event channels if not exist then render
            if (eventToken && Array.isArray(event_channels) && event_channels.length) {
                const ntwRoomChannels = ['room', ntw_keyword, roomslug, taohChannelDefault, 'channels']
                    .filter(Boolean).join('_');
                const store = objStores.ntw_store.name;
                const enc = v => encodeURIComponent(v ?? '');

                Promise.all(event_channels.map(async ch => {
                    const safeName = (ch?.channel_name);
                    const input = [roomslug, eventToken, safeName].map(String).sort().join('_');
                    const id = await generateSecureSlug(input, 16);
                    return { ch, id };
                }))
                    .then(pairs =>
                        getIntaoDataById(store, ntwRoomChannels, pairs.map(p => p.id))
                            .then(existing => ({ pairs, existing }))
                    )
                    .then(async ({ pairs, existing }) => {
                        const getExisting = (i, id) =>
                            Array.isArray(existing) ? existing[i] : existing?.[id];

                        const toCreate = pairs.filter((p, i) => !getExisting(i, p.id));
                        if (!toCreate.length) return;

                        await Promise.allSettled(toCreate.map(({ch, id}) => {
                                const channelData = JSON.stringify({
                                    name: (ch?.channel_name),
                                    description: (ch?.channel_desc),
                                    ptoken: my_pToken,
                                    eventtoken: eventToken
                                });

                                const channelMembers = JSON.stringify([]);
                                ...
                                $.ajax({
                                    ...
                                    data: {
                                        ...
                                        keyword: ntw_keyword,
                                        channel_id: id,
                                        channel_type: taohChannelDefault ?? 1,
                    ...
                    .catch(err => console.error('Event channel batch error:', err))
                    .finally(() => {
                        // Single refresh after check/creates
                        if ($('#browse_channels_wrapper').is(":visible")) {
                            loadChannelsList();
                        }
                    });
            }

            // Render Organizer Channels
            if (eventToken && _ORGANIZER_CHANNEL_ENABLE && event_owner_ptoken) {
                getNTWUserChannels({
                    roomslug,
                    keyword: ntw_keyword,
                    ...
                    if(channels.length > 0){
                        renderOrganizerChannelList(channels);
                    } else if (event_owner_ptoken !== my_pToken) {
                        const to_ptoken = event_owner_ptoken;
                        const organizer_channel_input = [roomslug, my_pToken, to_ptoken, 'organizer'].sort().join('_');
                        generateSecureSlug(organizer_channel_input, 16).then(channelId => {
                            ...
                            $.ajax({
                                ...
                                data: {
                                    ...
                                    channel_type: taohChannelOrganizer || 5,
                                    channel_data: channelData,
                                    channel_members: channelMembers,
                                    key: my_pToken
                                },
                                ...
                                success: function(res) {
                                    if (res.success) {
                                        // reload user organizer channel list in left section
                                        getNTWUserChannels({roomslug, keyword: ntw_keyword, type: taohChannelOrganizer, my_pToken}, true).then(({requestData, response}) => {
                                            return renderOrganizerChannelList(response);
                                        });
                                    } else {
                                        taoh_set_error_message("Error creating organizer channel: " + (res.error || "Unknown error"), false, 'toast-middle', [
                                            {
                                                text: 'OK',
                                                action: () => {},
                                ...
                                error: function(xhr, status, error) {
                                    taoh_set_error_message("Create organizer channel failed: " + error, false, 'toast-middle', [
                                        {
                                            text: 'OK',
                                            action: () => {},
                                            class: 'dojo-v1-btn float-right mt-3 mb-3'
            ...
            function loadChannelInfoPopup(chatWithChannel) {
                $.ajax({
                    url: _taoh_site_ajax_url,
                    method: 'POST',
                    dataType: 'json',
                    data: {
                        taoh_action: 'taoh_ntw_get_channel_type',
                        roomslug: ntw_room_key,
                        keyword: ntw_keyword,
                        key: my_pToken,
                        channel_id: chatWithChannel,
                    },
            ...
            $('#browseChannelTab .nav-link').on('click', function () {
                ...
                if (tabId === 'all-tab') {
                    ...
                    loadChannelsList();
                } else if (tabId === 'exhibitors-tab') {
                    $('#browseChannelQuery').val('');
                    $('#browse_exhibitor_channels').awloader('show');

                    if (eventToken) {
                        loadExhibitorChannelsList();
                    }
                } else if (tabId === 'sponsors-tab') {
                    $('#browseChannelQuery').val('');
                    $('#browse_sponsor_channels').awloader('show');
                    ...
                    $('#browseChannelQuery').val('');
                    $('#browse_session_channels').awloader('show');
            ...
            async function syncRoomStamp({roomslug, keyword, my_pToken}) {
                ...
                if (exhibitorChanged) {
                    ...
                    for (const channelId in freshExhibitorChannelStamp.response) {
                        ...
                        let hasUpdates = Number(channelLastStamp) > Number(channelExisting?.last_update_stamp ?? 0);
                        if (channelElem.length && currentChannelId != channelId && hasUpdates) {
                            console.log(lastSendMsgTimestamp[channelId]+" EXI", channelLastStamp);
                            channelElem.addClass('have_updates');
                        }
                    ...
                    getNTWUserChannels({roomslug: eventToken, keyword: ntw_keyword, type: taohChannelExhibitor, my_pToken}, true).then(({requestData, response}) => {
                        renderExhibitorChannelList(response);
                    });
                }

                /*if (sponsorChanged) {
                    // channel_type: taohChannelSponsor
                    const sponsorChannelBeforeTimestamp = parseInt(oldStamp?.channel || 0, 10);
                    const freshSponsorChannelStamp = await getRoomChannelStamp({
                        roomslug: eventToken,
                        keyword,
                        channel_type: taohChannelSponsor,
                        timestamp: sponsorChannelBeforeTimestamp,
                        my_pToken
                    }, true, false);

                    //console.log('Fetched fresh room sponsor channel stamp:', typeof freshSponsorChannelStamp.response, freshSponsorChannelStamp);
                    for (const channelId in freshSponsorChannelStamp.response) {
                        // get and update channel last fetch timestamp in intaodb
                        const channelLastStamp = freshSponsorChannelStamp.response[channelId];
                        const channelKey = ['channel', channelId].filter(Boolean).join('_');
                        const channelExisting = await IntaoDB.getItem(store, channelKey);
                    ...
                    getNTWUserChannels({roomslug: eventToken, keyword: ntw_keyword, type: taohChannelSponsor, my_pToken}, true).then(({requestData, response}) => {
                        renderSponsorChannelList(response);
                    });
                }*/
                ...
                if (sessionChanged) {
                    ...
                    console.log('Fetched fresh room session channel stamp:', typeof freshSessionChannelStamp.response, freshSessionChannelStamp);
                    for (const channelId in freshSessionChannelStamp.response) {
                        ...
                        let hasUpdates = Number(channelLastStamp) > Number(channelExisting?.last_update_stamp ?? 0);
                        if (channelElem.length && currentChannelId != channelId && hasUpdates) {
                            console.log(lastSendMsgTimestamp[channelId]+" SES", channelLastStamp);
                            channelElem.addClass('have_updates');
                        }
                    ...
                    getNTWUserChannels({roomslug: eventToken, keyword: ntw_keyword, type: taohChannelSession, my_pToken}, true).then(({requestData, response}) => {
                        renderSessionChannelList(response);
                    });
                }
                ...
                if (speedNetworkingChanged) {
                    ...
                    for (const channelId in freshsnStamp.response) {
                        ...
                        let hasUpdates = Number(channelLastStamp) > Number(channelExisting?.last_update_stamp ?? 0);
                        if (channelElem.length && currentChannelId != channelId && hasUpdates) {
                            console.log(lastSendMsgTimestamp[channelId]+" SN", channelLastStamp);
                            channelElem.addClass('have_updates');
                        }

                        //if(currentChannelId && currentChannelId == channelId) loadSpeedNetworkingData(currentChannelId, 0);
                        loadSpeedNetworkingData(channelId, 0);
                    }
                ...
                if (organizerChanged) {
                    ...
                    getNTWUserChannels({roomslug, keyword: ntw_keyword, type: taohChannelOrganizer, my_pToken}, true).then(({requestData, response}) => {
                        renderOrganizerChannelList(response);
                    });
                }
            ...
            $sel.select2({
                ...
                templateResult: (data) => {
                    ...
                    const img = data.avatar
                        ? `<img src="${data.avatar}" onerror="this.style.display='none'" style="width:22px;height:22px;border-radius:50%;margin-right:8px;">`
                        : '';
                    return $(`<span style="display:flex;align-items:center;">${img}<span>${data.text}</span></span>`);
                },
            ...
            function makeLabel(c){
                const name = c.chat_name || [c.fname,c.lname].filter(Boolean).join(' ') || c.email || 'Unknown';
                const t = valuesText(c.title)[0] || ''; const co = valuesText(c.company)[0] || '';
            ...
            $('#membersToAddForm').on('submit', function(e) {
                ...
                if (channelType == taohChannelExhibitor || channelType == taohChannelSponsor || channelType == taohChannelSession) {
                    membersRoomslug = eventToken;
                } else {
                    membersRoomslug = roomslug;
                }
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success) {
                            ...
                            alert(response.message || 'An error occurred while adding members.');
        ...
        const tribute = new Tribute({
            ...
            values: async (text, cb) => {
                try {                    
                    ...
                    const channelType = $('#channel-chat').data('channel_type');
                    ...
                    //console.log("test test test", channelInfo.members);
                        ...
                        if (ll.ptoken) {
                            ...
                            if (ll['cell'] !== null && ll['cell'] !== 'null') {
                                ...
                                Chat <i class="la la-angle-double-right ml-1"></i></button>`;
                                    ...
                                    <a data-ptoken="${l.ptoken}" class="d-flex flex-column align-items-center chat-username openProfileModal" style="gap: 3px;" href="javascript:void(0);" data-profile_token="${l.ptoken}">
...
<script>
    ...
    $("#createChannelForm").on("submit", async function (e) {
        ...
        $.ajax({
            ...
            success: function (res) {
                if (res.success) {
                    loadChannelsList();  // :rk use only if user in browse channel layout
                    ...
                    getNTWUserChannels({
                        ...
                        return renderChannelList(response, tempUserChannelArray);
                    }).then(() => {
    ...
    async function renderChannelList(channelArray = [], tempUserChannelArray = []) {
        ...
        for (const item of list) {
            ...
            const channelDescription = item.data?.description || 'description';
            ...
            if(last_fetch_stamp == lastSendMsgTimestamp[channelId]) {
                hasUpdates = false;
            }
            ...
            if(channelDescription == 'Presentation Room' || channelDescription == 'watch-party') {
                watch_party += `<li id="channel-${channelId}" class="channel-item ${isActive ? 'active' : ''} ${hasUpdates ? 'have_updates' : ''} ${isTempChannel ? 'temp' : ''}" data-channel_passcode="" data-speed_networking="0" data-channel_ticket_slug="" data-name="channel" data-channel_id="${channelId}" data-channel_type="${channelType}" data-channel_name="${channelName}">
            ...
            // html += `<li id="channel-${channelId}" class="channel-item ${isActive ? 'active' : ''} ${hasUpdates ? 'have_updates' : ''} ${isTempChannel ? 'temp' : ''}" data-channel_passcode="" data-speed_networking="0" data-channel_ticket_slug="" data-name="channel" data-channel_id="${channelId}" data-channel_type="${channelType}" data-channel_name="${channelName}">
            //         <a class="d-flex align-items-center justify-content-between" href="javascript: void(0);">
            //             <div class="channel_btn flex-grow-1 d-flex align-items-center overflow-hidden" title="${channelName}">
            //                 ${/*<div class="flex-shrink-0 me-2 channel_btn">
            //                     <div class="chat-user-img online align-self-center">
            //                         <div class="avatar-xs">
            //                             <span class="avatar-title rounded-circle bg-primary text-white">
            //                                 <span class="username">${channelInitial}</span>
            //                             </span>
            //                         </div>
            //                     </div>
            //                 </div>*/ ''}
                    ...
                    <a class="d-flex align-items-center justify-content-between" href="javascript:void(0);">
                        ...
                        <div class="dropdown ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <span class="dropdown-item star_channel" data-status="${channelStarred}" href="javascript:void(0);" data-channel_id="${channelId}">Unstar</span>
                ...
                <li id="channel-${channelId}" class="channel-item ${isActive ? 'active' : ''} ${hasUpdates ? 'have_updates' : ''} ${isTempChannel ? 'temp' : ''}" 
                    ...
                    <a class="d-flex align-items-center justify-content-between" href="javascript:void(0);">
                        ...
                        <div class="dropdown ml-2">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <span class="dropdown-item star_channel" data-status="${channelStarred}" href="javascript:void(0);" data-channel_id="${channelId}">Star</span>
                                <span class="dropdown-item channel_info_view" href="javascript:void(0);" data-channel_id="${channelId}">View</span>
                                <span class="dropdown-item delete_channel ${(channelDefault == 0 && channelCreatedBy == my_pToken) ? '' : 'd-none'}" href="javascript:void(0);" data-channel_id="${channelId}">Delete</span>
                            </div>
                        </div>
        ...
        if(watch_party != ''){
            $('#watch_partyChannel').html(watch_party);
        }
        if(mychannel_html != '') {
            $('#myChannelList').html(mychannel_html);
        } else {
            $('#myChannelList').html("");
        }
        if(html != '') {
    ...
    async function renderSpeedChannelList(channelArray = [], tempUserChannelArray = []) {
        ...
        for (const item of list) {
            ...
            const { last_fetch_stamp = 0, last_update_stamp = 0 } = channelExisting || {};
            const hasUpdates = (currentChannelId !== channelId) && (Number(last_fetch_stamp) > Number(last_update_stamp));
    ...
    async function renderDMChannelList(channelArray = []) {
        ...
        const store = objStores.ntw_store.name;
        for (const item of list) {
            const channelMembers = item.members || [];
            const to_ptoken = getPeerPToken(channelMembers, my_pToken);
            if (!to_ptoken) continue;
            const toUserInfo = await getUserInfo(to_ptoken, 'public');

            const channelId = item.id;
            const channelType = item.type;
            const channelName = toUserInfo.chat_name || '(unnamed)';

            const channelKey = ['channel', channelId].filter(Boolean).join('_');
            const channelExisting = await IntaoDB.getItem(store, channelKey);

            const fallbackSrc = `${_taoh_ops_prefix}/avatar/PNG/128/${toUserInfo?.avatar?.trim() || 'default'}.png`;
            const userAvatarSrc = await buildAvatarImage(toUserInfo.avatar_image, fallbackSrc);
            ...
            html += `<li id="channel-${channelId}" class="channel-item ${isActive ? 'active' : ''} ${hasUpdates ? 'have_updates' : ''} ${isTempChannel ? 'temp' : ''}" data-channel_passcode="" data-speed_networking="0" data-channel_ticket_slug="" data-name="channel" data-channel_id="${channelId}" data-channel_type="${channelType}" data-channel_name="${channelName}">
                    <a class="d-flex align-items-center justify-content-between" href="javascript: void(0);">
                        <div class="channel_btn flex-grow-1 d-flex align-items-center overflow-hidden" title="${channelName}">
                            ...
                            <div class="flex-grow-1 overflow-hidden channel_btn w-hide">
                                <span class="text-truncate mb-0 channel_name text-capitalize">${channelName}</span>
                            </div>
                        </div>
                    </a>
    ...
    async function renderExhibitorChannelList(channelArray = []) {
        ...
        for (const item of list) {
            ...
            const channelType = item.type;
            const channelName = item.data?.name || '(unnamed)';
            const exhibitorLogoSrc = item.data?.exhibitor_logo || '';
            const exhibitorRaffles = item.data?.exhibitor_raffles || 0;
            ...
            html += `<li id="channel-${channelId}" class="channel-item ${isActive ? 'active' : ''} ${hasUpdates ? 'have_updates' : ''} ${isTempChannel ? 'temp' : ''}" data-channel_passcode="" data-speed_networking="0" data-channel_ticket_slug="" data-name="channel" data-channel_id="${channelId}" data-channel_type="${channelType}" data-channel_name="${channelName}">
                        <a class="d-flex align-items-center justify-content-between" href="javascript: void(0);">
                            <div class="channel_btn flex-grow-1 d-flex align-items-center overflow-hidden" title="${channelName}">
                                ...
                                <div class="flex-grow-1 align-items-center overflow-hidden channel_btn w-hide" style="gap: 8px;">
                                    <h6 class="text-truncate mb-0 channel_name text-capitalize">${channelName}</h6>
                                    <!-- raffle svg -->
                                 ...
                                 <div class="channel_btn d-none w-hide">
    ...
    /*async function renderSponsorChannelList(channelArray = []) {
        const parse = v => {
            if (!v || typeof v === 'object') return v || {};
            try {
                return JSON.parse(v);
        ...
        for (const item of list) {
            ...
            const channelType = item.type;
            const channelName = item.data?.name || '(unnamed)';
            const sponsorLogoSrc = item.data?.sponsor_logo || '';
                            ...
                            <div class="channel_btn flex-grow-1 d-flex align-items-center overflow-hidden" title="${channelName}">
                                <div class="flex-shrink-0 me-2 channel_btn">
                                    <div class="chat-user-img online align-self-center">
                                        <div class="avatar-xs">
                                            <span class="avatar-title bg-white rounded-circle border text-white">
                                                <img src="${sponsorLogoSrc}" class="rounded-circle avatar-xs" alt="user-avatar">
                                            </span>
                                        </div>
                                    </div>
                                </div>

                                <div class="flex-grow-1 d-flex align-items-center overflow-hidden channel_btn" style="gap: 8px;">
                                    <h6 class="text-truncate mb-0 channel_name text-capitalize">${channelName}</h6>
                                </div>

                                <div class="channel_btn d-none">
                                    <div class="flex-shrink-0 ms-2">
                                        <svg width="14" height="14" viewBox="0 0 11 11" fill="none" xmlns="http://www.w3.org/2000/svg">
                                            <circle cx="5.5" cy="5.5" r="5.5" fill="#B2F2BB"/>
                                            <circle cx="5.5" cy="5.5" r="3.5" fill="#009944" fill-opacity="0.64"/>
    ...
    async function renderSessionChannelList(channelArray = []) {
        ...
        for (const item of list) {
            ...
            const channelType = item.type;
            const channelName = item.data?.name || '(unnamed)';
            const sessionLogoSrc = item.data?.speaker_logo || '';
    ...
    function send_message(channel_id, channel_type, message_text) {
    ...
    async function loadChannelMessages(channel_id, firstCall = 0) {
        ...
        if (firstCall === 1 && cachedData) {
            render_messages(cachedData.messages, cachedData.metadata);
        }
    ...
    async function loadSpeedNetworkingData(channel_id) {        
        ...
        if (response.status == 200) {
            ...
            if (Array.isArray(res.accept_ptoken) && res.accept_ptoken.length > 0) {
                ...
                for (const accept_ptoken of res.accept_ptoken) {
    ...
    async function updateRecentActivity(channel_id) {
        var allmessages = await loadChannelFromDB(channel_id);
    ...
    async function render_messages(messages, metadata, append = 1, layout = "main") {
        ...
        for (const msg of messages) {
            ...
            //console.log("=== msg msg <<===>>"+loadLayout, msg);
            //console.log("=== msg msg ===>>"+loadLayout, msg);
            ...
            if (timestamp) {
                ...
                if(aTag != "") {
                    ...
                    let msg = decodeURIComponent(msg_text.replace(/\+/g, ' '));
                    if (msg.length > 100) {
                        ...
                        $(`.pin_message_div${currentChannelId} .pin_message_msg_div`).append(`<div class="pin_msg flex-grow-1 ${(activeClass == "active") ? 'd-flex' : 'd-none'}" data-channel_id="${currentChannelId}" data-frm_message_id="${msg.message_id}">
                            ...
                            <div class="flex-shrink-0 dropdown mb-auto">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a data-chatwith="${msg.ptoken}" data-profile_token="${msg.ptoken}" class="dropdown-item ${msg.pinned_by === my_pToken ? 'd-none' : 'd-flex'} align-items-center justify-content-between openProfileModal">View Profile</a>
                                </div>
                            </div>
                        </div>`);
    ...
    function renderMessagesIfActive(channel, messages, metadata) {
        if (currentChannelId === channel) render_messages(messages, metadata, 0);
    }
    ...
    async function restrictedPtokenUpdate(chatwith) {
        ...
        let chkey = "room_"+ntw_keyword+"_"+roomslug+"_"+my_pToken+"_"+taohChannelSpeedNtw+"_channels";
        let existing = await IntaoDB.getItem(store, chkey);

        if (existing && existing.values && existing.values[0]) {
    ...
    async function loadConversation(currentElem){
        ...
        console.log("loadConversation", currentChannelId, channelInfo);
        ...
        if (channelInfo.members != undefined && channelInfo.members.length > 0) {
            $.each(channelInfo.members, async function (mkey, memtoken) {
                ...
                if ($('#members_list').find(`#member_${memtoken}`).length === 0) {
                    var members = `
                        <li id="member_${memtoken}" data-chatwith="${memtoken}" class="openchatacc">
                            <a href="javascript: void(0);">
                                <div class="d-flex align-items-center">
                        ...
                        `<div>
                                    ...
                                    ></div>
                                    <button type="button" id="${memtoken}" class="btn btn-sm mr-2" data-chatwith="${memtoken}" data-chatname="${d_data.chat_name}" data-live="" style="white-space: nowrap;font-size: small;">
    ...
    async function updateProfileInfo(userInfo, userLiveStatus, fromParticipants = 0) {
        ...
        console.log("userLiveStatus userLiveStatus", userLiveStatus);
        ...
        if(show_finish_setup_link == 1) {
            ...
            ` : ''}
            <a class="btn bor-btn openProfileModal view_more" data-profile_token="${userInfo.ptoken}">View More</a>
    ...
    async function openChannel(channelId, channelType) {
        ...
        $('.channnel_collapsible').html(convertLinks(channelInfo.data.description) || channelInfo.data.name);

        await loadChannelMessages(currentChannelId, 1);
        if(channelInfo?.data?.streaming_link) {
            //console.log("streaming_link", channelInfo.data.streaming_link);
    ...
    $(document).on("click", ".speedChannelList li", async function() {
        ...
        console.log("test test test 1234", ntwRoomChannels);
    ...
    $(document).on("click", ".channelList .channel_btn , .myChannelList .channel_btn ", async function (e) {
        // Prevent clicks while rendering
        ...
        try {
            ...
            if (channelInfo?.encrypted_passcode) {
                if (localStorage.getItem(channel_passcode_done) == 1 || my_pToken == channelInfo?.data?.ptoken) {
                    await openChannel(channelId, channelType); // ⬅️ make sure this awaits render_messages
                } else {
    ...
    $(document).on("click", ".exhibitorChannelList li", async function() {
        const currentElem = $(this);
        const channelId = currentElem.attr("data-channel_id");
        const channelType = currentElem.attr("data-channel_type");
    ...
    $(document).on("click", ".sponsorChannelList li", async function() {
        const currentElem = $(this);
        const channelId = currentElem.attr("data-channel_id");
        const channelType = currentElem.attr("data-channel_type");
    ...
    $(document).on("click", ".sessionChannelList li", async function() {
        const currentElem = $(this);
        const channelId = currentElem.attr("data-channel_id");
        const channelType = currentElem.attr("data-channel_type");
    ...
    async function loadDmWindow(to_ptoken) {
            ...
            $.ajax({
                ...
                success: function(res) {
                    if (res.success) {
                        ...
                        getNTWUserChannels({roomslug, keyword: ntw_keyword, type: taohChannelDm, my_pToken}, true).then(({requestData, response}) => {
                            return renderDMChannelList(response);
                        }).then(() => {
    ...
    $('#channel_refresh').on('click', function () {
        ...
        renderTasks.push(
            ...
            ).then(({ response }) => renderChannelList(response, tempUserChannelArray))
        );

        // Exhibitor + Sponsor Channels (event scope)
        if (eventToken) {
            renderTasks.push(
                Promise.resolve(
                    getNTWUserChannels({ roomslug: eventToken, keyword: ntw_keyword, type: taohChannelExhibitor, my_pToken }, true)
                ).then(({ response }) => renderExhibitorChannelList(response))
            );

            // renderTasks.push(
            //     Promise.resolve(
            //         getNTWUserChannels({ roomslug: eventToken, keyword: ntw_keyword, type: taohChannelSponsor, my_pToken }, true)
            //     ).then(({ response }) => renderSponsorChannelList(response))
            // );
        }
