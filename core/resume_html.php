        ...
        <div class="container res-con px-3 py-4 p-lg-5" style="margin-top: -160px;">
            <div class="mt-5 d-flex flex-wrap" style="gap: 12px;">
                ...
                <div class="r-left" style="max-width: 138px;">
                    <img class="profile-img mb-3" src="<?php echo TAOH_SITE_URL_ROOT;?>/assets/images/profile_room_1.png" alt="">
                    ...
                    <div class="d-flex align-items-center justify-content-center" style="gap: 12px;">
                        ...
                        <a href="#">
                            <svg width="23" height="23" viewBox="0 0 26 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M3.9 5.25C3.9 3.85761 4.44785 2.52226 5.42304 1.53769C6.39823 0.553123 7.72087 0 9.1 0C10.4791 0 11.8018 0.553123 12.777 1.53769C13.7521 2.52226 14.3 3.85761 14.3 5.25C14.3 6.64239 13.7521 7.97775 12.777 8.96231C11.8018 9.94688 10.4791 10.5 9.1 10.5C7.72087 10.5 6.39823 9.94688 5.42304 8.96231C4.44785 7.97775 3.9 6.64239 3.9 5.25ZM0 19.7818C0 15.7418 3.24187 12.4688 7.24344 12.4688H10.9566C14.9581 12.4688 18.2 15.7418 18.2 19.7818C18.2 20.4545 17.6597 21 16.9934 21H1.20656C0.540313 21 0 20.4545 0 19.7818ZM20.475 12.7969V10.1719H17.875C17.3347 10.1719 16.9 9.73301 16.9 9.1875C16.9 8.64199 17.3347 8.20312 17.875 8.20312H20.475V5.57812C20.475 5.03262 20.9097 4.59375 21.45 4.59375C21.9903 4.59375 22.425 5.03262 22.425 5.57812V8.20312H25.025C25.5653 8.20312 26 8.64199 26 9.1875C26 9.73301 25.5653 10.1719 25.025 10.1719H22.425V12.7969C22.425 13.3424 21.9903 13.7812 21.45 13.7812C20.9097 13.7812 20.475 13.3424 20.475 12.7969Z" fill="#53B2BE"/>
                            </svg>
                        </a>
                    </div>
                </div>
                ...
                <div class="r-right" style="flex: 1;">
                    ...
                    <div class="b-btm d-flex flex-wrap justify-content-between pb-3 mb-3 px-lg-4" style="gap: 12px;">
                        <h6 class="name"><span class="first-name">Andrew</span> <br> <span class="last-name">Tate Garfield</span></h6>

                        <div class="d-flex flex-wrap align-items-center" style="gap: 12px;">
                            <a href="#" class="btn std-btn py-1">Message</a>
                            <a href="#" class="btn std-btn py-1">Recruiter</a>
                            <a href="#" class="btn nrm-btn">
                                <svg width="23" height="23" viewBox="0 0 23 23" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class="py-4 px-lg-4">
                        <p class="p-info" style="gap: 12px;">
                            ...
                            <span>Talent Sourcing lead</span>
                        </p>
                    ...
                    <!-- about me -->
                     <div class="mt-5" style="max-width: 889px;">
                        ...
                        <div class="sec-content-con">
                            <div class="sec-content">
                                <p class="content-text pt-2">
                                Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's  standard dummy<br> text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.<br> <br>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br> Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged <a class="read-more">Read more...</a>
                                </p>
                                <div class="d-flex align-items-center py-4" style="gap: 12px;">
                    ...
                    <!-- Interests -->
                     <div class="mt-3" style="max-width: 889px;">
                        <h6 class="sec-title pb-2 b-2-btm pl-lg-4">
                            <span class="svg-con">
                        ...
                        <div class="sec-content-con">
                            <div class="sec-content">
                                ...
                                <ul class="nav nav-tabs my-4 interests-tabs" id="myTab" role="tablist" style="gap: 12px;">
                                    <!-- Tab Links -->
                                    <li class="nav-item">
                                        <a class="nav-link interests-tab active" data-toggle="tab" href="#open-to-work" role="tab" aria-controls="open-to-work" aria-selected="true">
                                            <span class="px-3 py-1">Open to Work</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link interests-tab" data-toggle="tab" href="#volunteering" role="tab" aria-controls="volunteering" aria-selected="true">
                                            <span class="px-3 py-1">Volunteering</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link interests-tab" data-toggle="tab" href="#career-switch" role="tab" aria-controls="career-switch" aria-selected="true">
                                            <span class="px-3 py-1">Career Switch</span>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link interests-tab common-border" data-toggle="tab" href="#interview-preparation" role="tab" aria-controls="interview-preparation" aria-selected="true">
                                            <span class="px-3 py-1">Interview Preparation</span>
                                        </a>
                                    </li>
                                </ul>
                                ...
                                <div class="tab-content px-0" id="myTabContent">
                                    <!-- open-to-work -->
                                    <div class="tab-pane fade show active" id="open-to-work" role="tabpanel" aria-labelledby="open-to-work">
                                        <p class="content-text pt-2">Open to Work - Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                    <!-- bartering -->
                                    <div class="tab-pane fade" id="bartering" role="tabpanel" aria-labelledby="bartering">
                                        <p class="content-text pt-2">Bartering - Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                    <!-- volunteering -->
                                    <div class="tab-pane fade" id="volunteering" role="tabpanel" aria-labelledby="volunteering">
                                        <p class="content-text pt-2">Volunteering - Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                    <!-- career-switch -->
                                    <div class="tab-pane fade" id="career-switch" role="tabpanel" aria-labelledby="career-switch">
                                         <p class="content-text pt-2">Career Switch - Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                    <!-- interview-preparation -->
                                    <div class="tab-pane fade" id="interview-preparation" role="tabpanel" aria-labelledby="interview-preparation">
                                        <p class="content-text pt-2">Interview Preparation - Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="sec-content b-2-btm pb-4">
                                ...
                                <div class="b-2-btm pt-3 pb-2 mb-3 d-flex align-items-center" style="gap: 12px;">
                                    <div class="d-flex align-items-center mr-lg-5" style="gap: 12px;">
                                        ...
                                        <div>
                                            <h6 class="text-sm-b mb-1">Boston Analytics</h6>
                                            <p class="text-xs">Boston, MA</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="d-flex align-items-center" style="gap: 12px;">
                                        ...
                                        <div>
                                            <h6 class="text-sm-b mb-1">Senior Data Analyst</h6>
                                            <p class="text-xs">May 2020 to June 2022</p>
                                        </div>
                                    </div>
                                </div>
                                <!-- Location -->
                                <h6 class="text-sm-b mb-2">Location: <span>Remote, Full Time</span></h6>
                                <!-- Industry -->
                                <h6 class="text-sm-b mb-3">Industry : <span>Information Technology</span></h6>
                                <!-- skills -->
                                <div class="d-flex align-items-center mb-3" style="gap:12px;">
                                    <h6 class="text-sm-b">Skills :</h6>
                                    <span class="skill-badge grey-light">Skill 1</span>
                    ...
                    <!-- Hobbies & Interests  ---- Club Information  --- -->
                     <div style="max-width: 889px;">
                        <div class="sec-content-con pb-3">
                            <div class="sec-content pb-4 d-flex flex-wrap" style="gap: 12px;">
                                <div class="card-list py-3" style="width: 100%; max-width: 347px;">
                                ...
                                <!--  -->
                                <div class="card-list py-3" style="flex: 1;">
                                    <h6 class="sec-title pb-2 b-2-btm px-3">
                                        <span class="svg-con">
                                    ...
                                    <div class="d-flex flex-wrap pt-3 px-3" style="gap: 6px;">
                                        <span class="club-info-list">Career Transition</span>
                                        <span class="club-info-list">Agriculture</span>
                     ...
                     <div style="max-width: 889px;">
                        <div class="sec-content-con">
                            <div class="sec-content d-flex align-items-center" style="gap: 12px;">
                                <a href="#" class="btn std-btn">Message</a>
