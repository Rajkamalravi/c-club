         ...
         <!-- <li class="nav-item <?php //echo (( stristr( $_SERVER[ 'REQUEST_URI' ], TAOH_PLUGIN_PATH_NAME.'/support' ) ) ? "active":"") ?>">
            ...
            <?php
              ...
              if(TAOH_LEARNING_ENABLE) { ?>
                <li class="nav-item">
                  <a style="cursor: pointer;" class="nav-link d-flex flex-column text-center" data-toggle="modal" data-target="#learn-modal"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="24" height="24" focusable="false">
        ...
        <ul class="generic-list-item off-canvas-menu-list pt-90px">
         ...
         <li class="nav-item <?php echo (( stristr( $_SERVER[ 'REQUEST_URI' ], TAOH_PLUGIN_PATH_NAME.'/support' ) ) ? "active":"") ?>">
          ...
          <?php if(TAOH_LEARNING_ENABLE) { ?>
            <li class="nav-item">
              <a class="nav-link cursor-pointer text-center" data-toggle="modal" data-target="#learn-modal"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="24" height="24" focusable="false">
                <path d="M3 3h4v4H3zm7 4h4V3h-4zm7-4v4h4V3zM3 14h4v-4H3zm7 0h4v-4h-4zm7 0h4v-4h-4zM3 21h4v-4H3zm7 0h4v-4h-4zm7 0h4v-4h-4z"></path>
                </svg><span class="small dropdown-toggle">Learning</span></a>
            </li>
          <?php }
