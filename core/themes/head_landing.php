...
<html lang="en">
  <head>
   ...
   <!-- <script src="https://accounts.google.com/gsi/client" async defer></script>   -->
    ...
    <link rel="stylesheet" href="<?php echo TAOH_CDN_CSS_PREFIX; ?>/landing.css?rand=<?php echo date('ymd');?>">
    <!-- <link rel="stylesheet" href="<?php echo TAOH_CDN_CSS_PREFIX; ?>/reads_lp_css.css?rand=<?php //echo date('ymd');?>"> -->
    <link rel="stylesheet" href="<?php echo TAOH_CDN_CSS_PREFIX; ?>/mobile_style.css">
    <link rel="stylesheet" href="<?php echo TAOH_CDN_CSS_PREFIX; ?>/slick.css">
    <link rel="stylesheet" href="<?php echo TAOH_CDN_CSS_PREFIX; ?>/taoh.css">
