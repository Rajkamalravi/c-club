        ...
        <div class="">
          <div class="question-main-bar">
            <div class="questions-snippet">
                <section class="caro-slider-section">
                    <div class="row">
                        <div class="large-12 columns">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                    ...
                                    if (!isset( $get_recipe_one['image']) || $get_recipe_one['image'] == 'null') $get_recipe_one['image'] = TAOH_CDN_PREFIX."/images/igcache/".urlencode( $get_recipe_one['title'] )."/900_600/blog.jpg";
                                ?>
                                <div class="item" style="width:230px">
                                    <a href="<?php echo TAOH_SITE_URL_ROOT.'/learning/blog/'.slugify2($get_recipe_one['title'])."-".$get_recipe_one['conttoken']; ?>">
                                    <div class="card">
                                        <div class="card-body">
                                        <div class="card-top-img">
                                            <img src="<?php echo $get_recipe_one['image']; ?>" alt="<?php echo $get_recipe_one['image']; ?>">
                                            <!-- <p>6hrs <span>20mins</span></p> -->
                                        </div>
                                        <div class="card-body-content">
                                            <p class="category-type"><?php echo ucwords($get_recipe_one['tags']); ?></p>
                                            <h4 class="card-title"><?php echo $get_recipe_one['title']; ?></h4>
                                            <div class="card-desc">
                                            <p class="card-text"><?php echo $get_recipe_one['description']; ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                ...
                                <div class="owl-nav d-block">
                                    <button type="button"  role="presentation" class="owl-prev"><span aria-label="Previous"><span class="fa fa-chevron-left" aria-hidden="true"></span></span></button>
                                    <button type="button" role="presentation" class="owl-next"><span aria-label="Next"><span class="fa fa-chevron-right" aria-hidden="true"></span></span></button>
                                </div>
                                <div class="owl-dots disabled"><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot active"><span></span></button><button role="button" class="owl-dot"><span></span></button><button role="button" class="owl-dot"><span></span></button></div>
                            </div>
                        </div>
                    </div>
                </section>
                <section class="caro-slider-section pt-30px">
                    <div class="row">
                        <div class="large-12 columns">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                    ...
                                    if (!isset( $get_recipe_two['image']) || $get_recipe_two['image'] == 'null') $get_recipe_two['image'] = TAOH_CDN_PREFIX."/images/igcache/".urlencode( $get_recipe_two['title'] )."/900_600/blog.jpg";
                                ?>
                                <div class="item" style="width:230px">
                                <a href="<?php echo TAOH_SITE_URL_ROOT.'/learning/blog/'.slugify2($get_recipe_two['title'])."-".$get_recipe_two['conttoken']; ?>">
                                    <div class="card">
                                        <div class="card-body">
                                        <div class="card-top-img">
                                            <img src="<?php echo $get_recipe_two['image']; ?>" alt="<?php echo $get_recipe_two['image']; ?>">
                                            <!-- <p>6hrs <span>20mins</span></p> -->
                                        </div>
                                        <div class="card-body-content">
                                            <p class="category-type"><?php echo ucwords($get_recipe_two['tags']); ?></p>
                                            <h4 class="card-title"><?php echo $get_recipe_two['title']; ?></h4>
                                            <div class="card-desc">
                                            <p class="card-text"><?php echo $get_recipe_two['description']; ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                ...
                <section class="caro-slider-section pt-70px">
                    <div class="row">
                        <div class="large-12 columns">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                    ...
                                    if (!isset( $get_recipe_three['image']) || $get_recipe_three['image'] == 'null') $get_recipe_three['image'] = TAOH_CDN_PREFIX."/images/igcache/".urlencode( $get_recipe_three['title'] )."/900_600/blog.jpg";
                                ?>
                                <div class="item" style="width:230px">
                                    <a href="<?php echo TAOH_SITE_URL_ROOT.'/learning/blog/'.slugify2($get_recipe_three['title'])."-".$get_recipe_three['conttoken']; ?>">
                                    <div class="card">
                                        <div class="card-body">
                                        <div class="card-top-img">
                                            <img src="<?php echo $get_recipe_three['image']; ?>" alt="<?php echo $get_recipe_three['image']; ?>">
                                            <!-- <p>6hrs <span>20mins</span></p> -->
                                        </div>
                                        <div class="card-body-content">
                                            <p class="category-type"><?php echo ucwords($get_recipe_three['tags']); ?></p>
                                            <h4 class="card-title"><?php echo $get_recipe_three['title']; ?></h4>
                                            <div class="card-desc">
                                            <p class="card-text"><?php echo $get_recipe_three['description']; ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                ...
                <section class="caro-slider-section pt-80px">
                    <div class="row">
                        <div class="large-12 columns">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                    ...
                                    if (!isset( $get_recipe_four['image']) || $get_recipe_four['image'] == 'null') $get_recipe_four['image'] = TAOH_CDN_PREFIX."/images/igcache/".urlencode( $get_recipe_four['title'] )."/900_600/blog.jpg";
                                ?>
                                <div class="item" style="width:230px">
                                    <a href="<?php echo TAOH_SITE_URL_ROOT.'/learning/blog/'.slugify2($get_recipe_four['title'])."-".$get_recipe_four['conttoken']; ?>">
                                    <div class="card">
                                        <div class="card-body">
                                        <div class="card-top-img">
                                            <img src="<?php echo $get_recipe_four['image']; ?>" alt="<?php echo $get_recipe_four['image']; ?>">
                                            <!-- <p>6hrs <span>20mins</span></p> -->
                                        </div>
                                        <div class="card-body-content">
                                            <p class="category-type"><?php echo ucwords($get_recipe_four['tags']); ?></p>
                                            <h4 class="card-title"><?php echo $get_recipe_four['title']; ?></h4>
                                            <div class="card-desc">
                                            <p class="card-text"><?php echo $get_recipe_four['description']; ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                        ...
                        <div class="large-12 columns">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                    ...
                                    if (!isset( $get_recipe_five['image']) || $get_recipe_five['image'] == 'null') $get_recipe_five['image'] = TAOH_CDN_PREFIX."/images/igcache/".urlencode( $get_recipe_five['title'] )."/900_600/blog.jpg";
                                ?>
                                <div class="item" style="width:230px">
                                    <a href="<?php echo TAOH_SITE_URL_ROOT.'/learning/blog/'.slugify2($get_recipe_five['title'])."-".$get_recipe_five['conttoken']; ?>">
                                    <div class="card">
                                        <div class="card-body">
                                        <div class="card-top-img">
                                            <img src="<?php echo $get_recipe_five['image']; ?>" alt="<?php echo $get_recipe_five['image']; ?>">
                                            <!-- <p>6hrs <span>20mins</span></p> -->
                                        </div>
                                        <div class="card-body-content">
                                            <p class="category-type"><?php echo ucwords($get_recipe_five['tags']); ?></p>
                                            <h4 class="card-title"><?php echo $get_recipe_five['title']; ?></h4>
                                            <div class="card-desc">
                                            <p class="card-text"><?php echo $get_recipe_five['description']; ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                        ...
                        <div class="large-12 columns" style="height:300px;">
                            ...
                            <div class="owl-carousel owl-theme">
                                <?php 
                                    ...
                                    if (!isset( $get_recipe_six['image']) || $get_recipe_six['image'] == 'null') $get_recipe_six['image'] = TAOH_CDN_PREFIX."/images/igcache/".urlencode( $get_recipe_six['title'] )."/900_600/blog.jpg";
                                ?>
                                <div class="item" style="width:230px">
                                    <a href="<?php echo TAOH_SITE_URL_ROOT.'/learning/blog/'.slugify2($get_recipe_six['title'])."-".$get_recipe_six['conttoken']; ?>">
                                    <div class="card">
                                        <div class="card-body">
                                        <div class="card-top-img">
                                            <img src="<?php echo $get_recipe_six['image']; ?>" alt="<?php echo $get_recipe_six['image']; ?>">
                                            <!-- <p>6hrs <span>20mins</span></p> -->
                                        </div>
                                        <div class="card-body-content">
                                            <p class="category-type"><?php echo ucwords($get_recipe_six['tags']); ?></p>
                                            <h4 class="card-title"><?php echo $get_recipe_six['title']; ?></h4>
                                            <div class="card-desc">
                                            <p class="card-text"><?php echo $get_recipe_six['description']; ?></p>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
