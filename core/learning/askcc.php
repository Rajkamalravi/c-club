                ...
                <div>
                    ...
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            ...
                            <div class="card" id="chat1" style="border-radius: 15px; background-image: url('<?php echo TAOH_CDN_PREFIX."/app/asqs/images/asq_ai.png"; ?>'); background-color: #ccc; background-position: center; background-repeat: no-repeat; ">
                                <div
                                class="card-header d-flex justify-content-between align-items-center p-3 text-white border-bottom-0"
                                style="border-top-left-radius: 15px; border-top-right-radius: 15px; background-color: #ccc;">
                                   <?php //<i class="fas fa-angle-left text-white"></i> ?>
                                    <p class="mb-0 fw-bold text-dark">#AskTheCoach: Community Powered Career Coach</p>
    ...
    function render_chat_template(data, slot) {
		...
		if(data.length === 0) {
			...
			$.each(data, function(i, v){
                if(v.sender == "#AskTheCoach"){
                    slot.append(`
                        <div class="d-flex flex-row justify-content-start mb-4">
                            <img src="<?php echo TAOH_CDN_PREFIX."/app/asqs/images/asq_ai_250.png"; ?>"
