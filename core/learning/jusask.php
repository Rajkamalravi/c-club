...
//echo $url = TAOH_OPS_PREFIX . '/' .$taoh_call.'?'.http_build_query($taoh_vals);
$out = json_decode(taoh_apicall_get( $taoh_call, $taoh_vals, TAOH_OPS_PREFIX ), true);
//print_r($out);die();
if (0)
    ...
    <!--<div class="alert alert_error w-50 text-center" style="margin-left: 25%;" id="alert_error">
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <h1 class="text-primary">#JusAskTheCoach</h1>
                <div>
                    <h3 class="text-white"></h3>
                    <div class="row d-flex justify-content-center">
                        <div class="col-md-12 col-lg-12 col-xl-12">
                            <div class="card" id="chat1" style="border-radius: 15px; background-image: url('<?php echo TAOH_CDN_PREFIX."/app/jusask/images/jusask_sq_512.png"; ?>'); background-color: #fff; background-position: center; background-repeat: no-repeat; background-color: rgba(0,0,0,0.25);">
                                <div
                                ...
                                style="border-top-left-radius: 15px; border-top-right-radius: 15px; background-color: #000;">
                                   <?php //<i class="fas fa-angle-left text-white"></i> ?>
                                    <p class="mb-0 fw-bold text-white">#JusAsk: Community Powered Career Coach</p>
                                    <a href="<?php echo TAOH_SITE_URL_ROOT.'/'.TAOH_CURR_APP_SLUG.'/jusask'; ?>"><i class="fas fa-times text-white"></i></a>
                                </div>
                                <?php
                                if ( taoh_user_is_logged_in() ) {
                                ?>
                                <div class="card-body">
                                    <div id ="jusaskChat"></div>
                                ...
                                <?php
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-outline">
                                            <div class="d-flex flex-wrap align-items-center">
                                                <div class="d-flex flex-wrap align-items-center flex-grow-1">
                                                    <a href="<?php echo TAOH_LOGIN_URL."?redirect_url=".TAOH_REDIRECT_URL; ?>" class="btn btn-dark btn-lg active" style="width: 100%;" role="button" aria-pressed="true">Login / Signup To Chat With Me, Your Career Coach!</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div><p class="text-justify text-sm"><small>* We are currently testing and improving #JusAskTheCoach to give better answers. So, we welcome your feedback. Lastly, please do not share any sensitive information while using the chatbot. We value your privacy and confidentiality.</small></p></div>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    ...
    function taoh_chat_init() {
		...
		jQuery.post("<?php echo taoh_site_ajax_url(); ?>", data, function(response) {
            ...
            $('.load').hide();
			render_chat_template(response, jusaskChat);
		}).fail(function() {
                ...
                if(v.sender == "#JusAskTheCoach"){
                    slot.append(`
                        <div class="d-flex flex-row justify-content-start mb-4">
                            <img src="<?php echo TAOH_CDN_PREFIX."/app/jusask/images/jusask_sq_64.png"; ?>"
                            alt="#JusAskTheCoach" style="width: 50px; height: 100%;">
