    ...
    <div class="row bg-white">
        <div class="col-lg-8 m-15px-tb"> 
          <div class="mt-3 sticky-top light-dark">
              <?php taoh_newsletter_search_widget(); ?>
          </div>
        ...
        <div class="col-lg-4 m-15px-tb border-left">
          <section id="sticky">
              <div class="border-bottom">TAGS WIDGET
                  <?php tags_widget(); ?>
              </div>
...
<script type="text/javascript">
		...
		getIntaoDb(dbName).then((db) => {
				...
				datareadsrequest.onsuccess = ()=> {
					...
					if(readsstoredatares !== undefined && readsstoredatares !== null && readsstoredatares !== "" && readsstoredatares !== "undefined" && readsstoredatares !== "null"){
						...
						taoh_newsletter_init(queryString);
						//taoh_blogs_init();
					}
				}
			}).catch((error) => {
  ...
  function taoh_newsletter_init(queryString="") {
  ...
  $.each(data.output.list, function(i, v){
     arr_cont.push(v.conttoken.toString());
      ...
      v.blurb.image = prefix+"/images/igcache/"+encodeURIComponent(taoh_title_desc_decode(v.title))+"/900_600/blog.jpg"; 
      slot.append(`
              <div class="col-lg-6">
                <div class="p-3">
                    <div class="cover-image-container">
                      ...
                      <a class="mt-2 dash_metrics" data-metrics="view" data-type="reads" conttoken="${v.conttoken}" href="d/${convertToSlug(taoh_title_desc_decode(v.title))}-${v.conttoken}">
                    ...
                    <h3  class="mt-2 h3-title">
                        <a class="" href="<?php echo TAOH_NEWSLETTER_URL; ?>/d/${convertToSlug(taoh_title_desc_decode(v.title))}-${v.conttoken}">
