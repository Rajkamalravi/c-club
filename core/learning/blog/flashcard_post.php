                    ...
                    <form method="post" class="card-body" action="<?php echo TAOH_ACTION_URL .'/blog'; ?>">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="title" placeholder="e.g. Is there an R function for finding the index of an element in a vector?">
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Details</label>
                            <div class="form-group">
                                <textarea class="text-editor form-control form--control user-text-editor" name="description" rows="10" cols="80"></textarea>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
