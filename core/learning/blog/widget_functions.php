...
function taoh_wellness_widget_get($reads_type){
    ...
    // $cache_name = $url.'_users_landing_' . hash('sha256', $url . serialize($taoh_vals));
  ...
  /*function taoh_metrics_call_for_reads($data){
    $click_view = 'view';
    $log_nolog_token = ( taoh_user_is_logged_in()) ? $user_ptoken : TAOH_API_TOKEN_DUMMY;
    $token = TAOH_API_TOKEN;

    foreach($data as $key=>$val){
      $contoken  = $val['conttoken'];
      $values = json_encode(array($contoken,'blog',$token,'view',time(),TAOH_API_SECRET));
  ...
  function taoh_all_reads_widget( $val_arr, $design ){
    ...
    //added by kalpana
    //taoh_metrics_call_for_reads($val_arr);
    return 1;
  }
  ...
  <?php foreach ($first_get as $first ){
      ...
      <div class="col-md-4">
          <div class="card card-item">
            <div class="cover-image-container" style="height: 100%; max-height: 196px;">
              <div class="glass-overlay"></div>
              <div class="bg-image" style="background-image: url('<?php echo $first['image']; ?>')"></div>
              <a class="dash_metrics" data-metrics="view" data-type="reads" conttoken="<?php echo $first['conttoken']; ?>" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($first['title']))."-".$first['conttoken']); ?>">
                <img class="main-image card-img-top" src="<?php echo $first['image']; ?>" data-src="<?php echo $first['image']; ?>" alt="Card image">
              </a>
            </div>

            <div class="mt-2">
              <h3 class="h3-title">
                <a style="overflow-wrap: anywhere;" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($first['title']))."-".$first['conttoken']); ?>">
    ...
    <div class="col-lg-6">
      <div class="p-3">
        <div class="cover-image-container">
          <div class="glass-overlay"></div>
          <div class="bg-image" style="background-image: url('<?php echo $first['image']; ?>')"></div>
          <a class="mt-2 dash_metrics" data-metrics="view" data-type="reads" conttoken="<?php echo $first['conttoken']; ?>" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($first['title']))."-".$first['conttoken']); ?>">
              <img class="main-image" width="100%" src="<?php echo $first['image']; ?>" data-src="<?php echo $first['image']; ?>" alt="Card image">
          </a>
        </div>
        ...
        <div class="mt-2 descrip">
          <?php echo taoh_blog_desc_decode($first['short']); // full - short ?>
        </div>
      </div>
    </div>
    <?php } ?>
...
<div class="row border-bottom">
  ...
  <div class="col-sm-6">
    <div class="d-flex p-3">
      <a class="mt-2 dash_metrics" data-metrics="view" data-type="reads" conttoken="<?php echo $second['conttoken']; ?>" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($second['title']))."-".$second['conttoken']); ?>">
          <img style="min-width: 100px; max-width: 100px; border-radius: 6px;" src="<?php echo $second['image']; ?>" data-src="<?php echo $second['image']; ?>" alt="Card image">
      </a>
      <h3 class="mt-2 sm-title">
          <a class="" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($second['title']))."-".$second['conttoken']); ?>">
      ...
      <div class="col-lg-6">
        <div class="p-3">
          ...
          <div class="d-flex mb-3">
            <a class="mt-2 dash_metrics" data-metrics="view" data-type="reads" conttoken="<?php echo $second['conttoken']; ?>" href="<?php taoh_blog_link(slugify2(taoh_title_desc_decode($second['title']))."-".$second['conttoken']); ?>">
                <img style="min-width: 100px; max-width: 100px; border-radius: 6px;" src="<?php echo $second['image']; ?>" data-src="<?php echo $second['image']; ?>" alt="Card image">
            </a>
            <h3 class="mt-2 sm-title">
                <a class="" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($second['title']))."-".$second['conttoken']); ?>">
    ...
    <div class="card-body">
        ...
        <?php foreach ($right2 as $post) { ?>
            <div class="media media-card media--card media--card-2 light-dark-card">
                <div class="media-body">
                    <h3 class="h3-title">
                      <a href="<?php echo TAOH_SITE_URL_ROOT."/jobs/d/".slugify2(taoh_title_desc_decode($post['title']))."-".$post['conttoken']?>">
  ...
  ?>
    ...
    <div class="mt-3 mb-3">
        ...
        <div class="mb-3">
          <div class="cover-image-container">
            <div class="glass-overlay"></div>
            <div class="bg-image" style="background-image: url('<?php echo $right1['image']; ?>')"></div>
            <a class="mt-2 dash_metrics" data-metrics="view" data-type="reads" conttoken="<?php echo $right1['conttoken']; ?>" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($right1['title']))."-".$right1['conttoken']); ?>">
              <img class="main-image" width="100%" src="<?php echo $right1['image']; ?>" data-src="<?php echo $right1['image']; ?>" alt="Card image">
            </a>
          </div>
          <h3  class="mt-2 sm-title">
              <a class="" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($right1['title']))."-".$right1['conttoken']); ?>">
                  <?php echo ucfirst(taoh_title_desc_decode($right1['title'])); ?>
              </a>
          </h3>
          <div class="mt-2 descrip claimedRight">
              <?php echo taoh_blog_desc_decode($right1['full']); ?>
          </div>
        </div>
    </div>
    </div>
  ...
  ?>
    ...
    <div class="mt-3 mb-3">
        ...
        <div class="mb-3">
          <div class="cover-image-container">
            <div class="glass-overlay"></div>
            <div class="bg-image" style="background-image: url('<?php echo $right3['image']; ?>')"></div>
            <a class="mt-2 dash_metrics" data-metrics="view" data-type="reads" conttoken="<?php echo $right3['conttoken']; ?>"  href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($right3['title']))."-".$right3['conttoken']); ?>">
              <img class="main-image" width="100%" src="<?php echo $right3['image']; ?>" data-src="<?php echo $right3['image']; ?>" alt="Card image">
            </a>
          </div>
          <h3  class="mt-2 sm-title">
              <a class="" href="<?php echo taoh_blog_link(slugify2(taoh_title_desc_decode($right3['title']))."-".$right3['conttoken']); ?>">
                  <?php echo ucfirst(taoh_title_desc_decode($right3['title'])); ?>
              </a>
          </h3>
          <div class="mt-2 descrip claimedRight">
              <?php echo taoh_blog_desc_decode($right3['short']) // full - short; ?>
          </div>
        </div>
    </div>
    </div>
