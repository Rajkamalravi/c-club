   ...
   <!--  <span class="stroke-shape stroke-shape-1"></span>
    ...
    <div class="container">
        <div class="hero-content pt-80px pb-80px">
            <h2 class="section-title">Create a Blog</h2>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card card-item">
                    <form method="post" class="card-body" action="<?php echo TAOH_ACTION_URL .'/blog'; ?>">
                        <div class="hidden">
                        ...
                        <div class="input-box">
                            ...
                            <div class="form-group">
                                <input class="form-control form--control" type="text" name="title" placeholder="e.g. Is there an R function for finding the index of an element in a vector?" required>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium mb-0">Details</label>
                            <div class="form-group">
                                <textarea class="text-editor form-control form--control user-text-editor" name="description" rows="10" cols="80" required></textarea>
                            </div>
                        </div><!-- end input-box -->
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Image Links</label>
                            <input class="form-control form--control" name="image[]" type="text" value="" placeholder="Image URL Here">
                        ...
                        <div class="input-box">
                            ...
                            <input class="form-control form--control" name="media" type="text" value="" placeholder="External Link Here">
                        </div> <br>

                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Profile Pre Tag</label>
                            <input class="form-control form--control" name="profile_pretag" type="text" value="Inspired By:" placeholder="Profile Pre Tag">
                        </div> <br>
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">First Name</label>
                            <input class="form-control form--control" name="fname" type="text" value="" placeholder="First Name">
                        </div> <br>
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Last Name</label>
                            <input class="form-control form--control" name="lname" type="text" value="" placeholder="Last Name">
                        </div> <br>
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Profile Image URL</label>
                            <input class="form-control form--control" name="avatar" type="text" value="" placeholder="Profile Image URL">
                        </div> <br>
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Profile Link</label>
                            <input class="form-control form--control" name="profile_link" type="text" value="" placeholder="Profile Link">
                        </div> <br>

                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Post Blog Text</label>
                            <input class="form-control form--control" name="postblog_text" type="text" value="" placeholder="Post Blog Text">
                        </div> <br>
                        <div class="input-box">
                            <label class="fs-14 text-black fw-medium">Post Blog Link</label>
                            <input class="form-control form--control" name="posttaoh_blog_link" type="text" value="" placeholder="Post Blog Link">
                        </div> <br>
                        <div class="input-box">
                            ...
                            <div class="form-group">
                              <input id="blogCategorySelect" class="input-tags input--tags" type="text" name="category[]" placeholder="e.g. General Search Strategy">
