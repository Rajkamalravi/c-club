		...
		getIntaoDb(dbName).then((db) => {
            ...
            datareadswellrequest.onsuccess = ()=> {
                ...
                if(readswellstoredatares !== undefined && readswellstoredatares !== null && readswellstoredatares !== "" && readswellstoredatares !== "undefined" && readswellstoredatares !== "null"){
                    ...
                    render_blog_template(readswellstoredata, eventArea);
           ...
           console.log('Getreadswellnesslistdata Error:', error);
       	});
	}
...
function indx_reads_list(readslistdata){
    ...
    var reads_setting_timedata = { taoh_ttl: readswell_list_name,time:reads_setting_time };
...
setInterval(function(){
    <?php if(TAOH_INTAODB_ENABLE) { ?>
        checkTTL(readswell_list_name,store_name);
    <?php } ?>
},30000);
  //Trending Bar Start
