...
#tagsSelect-ts-dropdown .no-results{
    display:none;
}
#blog_post_form .tag_select .ts-wrapper.multi .ts-control .item {
    position: initial;
    width: auto;
    height: 21px;
    line-height: 19px;
				...
				<div class="card-body">
					...
					<form class="mt-3" id="blog_post_form" method="post" action="<?php echo TAOH_ACTION_URL .'/blog'; ?>">
                        <div class="hidden">
                          ...
                          <?php if( ( isset( $conttoken ) ) && $conttoken != 'stlo' && $conttoken != '') { ?>
						...
						<div class="row">
                            <div class="mb-12 col-md-12">
								...
								<input name="title" type="text" value="<?php echo taoh_title_desc_decode($response['output']['title']); ?>" class="form-control" required>
							</div>
                            <div class="mb-12 col-md-12">
							...
							<div class="mb-3 col-md-12">
								...
								<textarea class="summernote" id="summernote" name="description" rows="10" cols="80"><?php echo taoh_title_desc_decode($response['output']['description']); ?></textarea>
							</div>
                            ...
                            <div class="mb-3 col-md-6 tag_select">
                                <label class="form-label text-black fw-medium">Tags</label>
                                <input class="form-control" value="<?php echo $response['output']['tags']; ?>" name="tags" type="text">
							</div>
                            <div class="mb-3 col-md-6">
