    ...
    <div class="container bg-white">
        <div class="hero-content text-center">
            ...
            <?php
                ...
                array_push($hero_arr, $rand_blog['conttoken']);
                  ...
                  >
                        ...
                        <div class="col-lg-6">
                            <div class="item-details">
                                ...
                                <a conttoken="${v.conttoken}" href="<?php echo TAOH_SITE_URL_ROOT.'/'.TAOH_CURR_APP_SLUG; ?>/blog/${convertToSlug(taoh_title_desc_decode(v.title))}-${v.conttoken}">
...
function indx_reads_list(readslistdata){
    var reads_taoh_data = { taoh_data:readsjob_list_name,values : readslistdata };
    let reads_setting_time = new Date();
    reads_setting_time = reads_setting_time.setMinutes(reads_setting_time.getMinutes() + 600);
    var reads_setting_timedata = { taoh_ttl: readsjob_list_name,time:reads_setting_time };
...
setInterval(function(){
    <?php if(TAOH_INTAODB_ENABLE) { ?>
        checkTTL(readsjob_list_name,store_name);
    <?php } ?>
},30000);
