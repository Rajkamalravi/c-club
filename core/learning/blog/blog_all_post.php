...
if(isset( $conttoken ) && $conttoken != 'stlo' && $conttoken != ''){
    ...
    // $cache_name = $url.'_reads_detail_' . hash('sha256', $url . serialize($taoh_vals));
				...
				<div class="card-body">
					...
					<form class="mt-3" id="blog_post_form" method="post" action="<?php echo TAOH_ACTION_URL .'/blog'; ?>">
						...
						<div class="row">
                            ...
                            <div class="mb-12 col-md-12">
								<label class="form-label text-black fw-medium">User Token <span style="color:red;">*</span></label>
								<input name="user_token" readonly type="text" value="<?php echo taoh_get_dummy_token(); ?>" class="form-control">
							</div>
                            <div class="mb-12 col-md-12">
