...
<!--<?php //if($_GET['success']){?>
<div class="alert alert-success alert-dismissable m-0 text-center" id="flash-msg">
<button aria-hidden="true" data-dismiss="alert" class="close" type="button">×</button>
<h4><i class="icon fa fa-check"></i> Your account was successfully created!</h4>
</div>
<?php //} ?>-->
<section class="blog-area pt-40px pb-80px" style="background-color: #f1f1f1;">
    <div class="container text-center">
        <div class="tab">
            <h2 class="text-black text-center mb-2">You're Ready to Explore</h2>
            <h3 class="text-black text-center fs-20">Join the world's fastest growing professional community where you could find all things career, and an inclusive community that helps you grow faster.</h3>
            <div class="row mt-4">
                <div class="col-lg-3 col-md-6 mt-2">
                <div class="app-box text-black">
                    <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 32.085 27.854">
                    ...
                    <p class="mt-2 font-weight-bold">Asks</p>
                    <p class="mt-2 app-text">Get your career growth questions answered</p>
                    <div class="mt-2"><a href="<?php echo TAOH_SITE_URL_ROOT.'/asks'?>" class="btn btn-sm btn-primary rounded">Ask Questions <i class='far fa-arrow-alt-circle-right' style='font-size:15px;color:white'></i></a></div>
                </div>
                </div>
                <div class="col-lg-3 col-md-6 mt-2">
                <div class="app-box text-black">
                    <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 31.051 27.691">
                    ...
                    <p class="mt-2 font-weight-bold">Jobs</p>
                    <p class="mt-2 app-text">Connect with job opportunities</p>
                    <div class="mt-2"><a href="<?php echo TAOH_SITE_URL_ROOT.'/jobs'?>" class="btn btn-sm btn-primary rounded">Search Jobs <i class='far fa-arrow-alt-circle-right' style='font-size:15px;color:white'></i></a></div>
                </div>
                </div>
                <div class="col-lg-3 col-md-6 mt-2">
                <div class="app-box text-black">
                    <div>
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 25.251 26.169">
                    ...
                    <p class="mt-2 font-weight-bold">Events</p>
                    <p class="mt-2 app-text">Attend networking and growth events</p>
                    <div class="mt-2"><a href="<?php echo TAOH_SITE_URL_ROOT.'/events'?>" class="btn btn-sm btn-primary rounded">Browse Events <i class='far fa-arrow-alt-circle-right' style='font-size:15px;color:white'></i></a></div>
                </div>
                </div>
                <div class="col-lg-3 col-md-6 mt-2">
                <div class="app-box text-black">
                    <div>
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" data-supported-dps="24x24" fill="currentColor" class="mercado-match" width="50" height="50" focusable="false">
                        <path d="M3 3h4v4H3zm7 4h4V3h-4zm7-4v4h4V3zM3 14h4v-4H3zm7 0h4v-4h-4zm7 0h4v-4h-4zM3 21h4v-4H3zm7 0h4v-4h-4zm7 0h4v-4h-4z"></path>
                    </svg>
                    </div>
                    <p class="mt-2 font-weight-bold">Learning</p>
                    <p class="mt-2 app-text">Grow your skills and career with learning</p>
                    <div class="mt-2"><a href="<?php echo TAOH_SITE_URL_ROOT.'/learning'?>" class="btn btn-sm btn-primary rounded">Read n Grow <i class='far fa-arrow-alt-circle-right' style='font-size:15px;color:white'></i></a></div>
                </div>
                </div>
            </div>
