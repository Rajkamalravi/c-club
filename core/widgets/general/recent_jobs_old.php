...
<?php if($widget_type == 'new' && TAOH_JOBS_ENABLE){ ?>
    <div class="light-dark-card right-side-block">
        <div class="">
            <div class="">
                <h3 class="fs-17 d-flex align-items-center justify-content-between">
                    <?php
                    echo $head_title;
                    if (taoh_user_is_logged_in() && isset($_SESSION[TAOH_ROOT_PATH_HASH]['USER_INFO']->type) && $_SESSION[TAOH_ROOT_PATH_HASH]['USER_INFO']->type == 'employer') {
                        ?>
                        <a href="<?php echo TAOH_SITE_URL_ROOT.'/jobs/post'; ?>" type="button" class="btn btn-primary ml-auto fs-12">+ Post a Job</a>
                        <?php
                    }
                    ?>
                </h3>
                    ...
                    <div class="media media--card-2">
                        <div class="media-body">
                            ...
                            foreach ($job_list as $key => $value) {
                                ...
                                ?>
                                <a class="" target="_blank" href="<?php echo $detail_url; ?>">
                                    <div class="p-3 mb-3" style="border: 2px solid #D3D3D3; border-radius: 12px;">
                                        <div class="d-flex align-items-start justify-content-between">
                                            <span class="recent-job-title" style="">
                                        ...
                                        <p class="my-2 recent-job-location"><?php echo $wid_job_location; ?></p>
                                    </div>
                                </a>
                                <?php
                            }

                            if (!stristr($_SERVER['REQUEST_URI'], TAOH_PLUGIN_PATH_NAME . '/jobs')) {
                                ?>
