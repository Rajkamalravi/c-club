...
$widget_id = $data['widget_id'] ?? 'widget_id';
...
$share_text_js = $desc;
$share_title_js = $page_title;
?>
<!-- <div class="social-icon-box d-flex text-center justify-content-center"> -->
<div class="social-icon-box d-flex text-center justify-content-center" data-widget-id="<?php echo $widget_id; ?>">
    ...
    <a class="ml-3 icon-element icon-element-sm shadow-sm text-gray hover-y share_counts email-btn" data-click="email" style="background-color:#B23121; margin-bottom:10px;cursor:pointer;" target="_blank" title="Share vai Email">
    ...
    <a class="ml-3 icon-element icon-element-sm shadow-sm text-gray hover-y copys-btns" style="background-color:#00762B; margin-bottom:10px;cursor:pointer;">
        <svg focusable="false" class="svg-inline--fa fa-copy fa-w-16" width="16" height="16" viewBox="0 0 28 32" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M13 0H20.7563C21.55 0 22.3125 0.31875 22.875 0.88125L27.1187 5.125C27.6812 5.6875 28 6.45 28 7.24375V21C28 22.6562 26.6562 24 25 24H13C11.3438 24 10 22.6562 10 21V3C10 1.34375 11.3438 0 13 0ZM3 8H8V12H4V28H16V26H20V29C20 30.6562 18.6562 32 17 32H3C1.34375 32 0 30.6562 0 29V11C0 9.34375 1.34375 8 3 8Z" fill="white"/>
        </svg>
    </a>
</div>
