    var my_ptoken = window._erd_cfg.myPtoken;

    var eventlivelink = window._erd_cfg.eventLiveLink;

    let erd_my_following_ptoken_list = window._erd_cfg.myFollowingPtokenList;
    ...
    function getTicketTypes() {
        const eventdetailBaseInfoKey = `event_detail_${window._erd_cfg.eventtoken}`;
    ...
    async function constructRSVPList(eventtoken, response, search = '', redis = 0, listAppend = 0) {
        ...
        for (const user_data of res) {
            ...
            if (typeof v !== 'undefined' && v && v.ptoken !== undefined
                ...
                && v.fname != window._erd_cfg.siteNameSlug
    ...
    function loadMoreRsvpedUsers() {
        ...
        var eventtoken = window._erd_cfg.eventtoken;
    ...
    $(document).on('click', '.event_download_rsvp', function () {
        ...
        let eventtoken = window._erd_cfg.eventtoken;


        /*var url = _taoh_site_url_root + '/events/export_rsvp/?eventtoken=' + eventtoken;
    ...
    function eventCheckinList(eventtoken, search = '') {
        ...
        const myCountry = window._erd_cfg.userCountry;
